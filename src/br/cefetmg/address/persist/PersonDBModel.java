...
public class PersonDBModel implements DBModel<PersonModel>{
    ...
    @Override
    public void insert(PersonModel person) throws PersistException {
        try {
            if (person == null) {
                throw new PersistException("Entidade não pode ser nula.");
            }
            ...
            Logger.getLogger(PersonDBModel.class.getName()).log(Level.SEVERE, null, ex);
            throw new PersistException(ex);
        }
    }

    @Override
    public void update(PersonModel person) throws PersistException {
        try {
           Connection connection = ConnectionFactory.getConnection();
    ...
    @Override
    public PersonModel delete(Long id) throws PersistException {
        try {
    ...
    @Override
    public PersonModel getById(Long id) throws PersistException {
        try {
            Connection connection = ConnectionFactory.getConnection();
    ...
    @Override
    public List<PersonModel> listAll() throws PersistException {
        try {
            Connection connection = ConnectionFactory.getConnection();
